...
class TestListFields:
    ...
    def test_list_fields_rich_format(self):
        """Should format fields for rich output."""
        stdout, stderr, code = run_cli_raw("jira", "fields", "--format", "rich")
        assert code == 0
...
class TestListCustomFields:
    ...
    def test_list_custom_fields_rich_format(self):
        """Should format custom fields for rich output."""
        stdout, stderr, code = run_cli_raw("jira", "fields/custom", "--format", "rich")
        assert code == 0
