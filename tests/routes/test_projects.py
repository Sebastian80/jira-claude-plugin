...
class TestListProjects:
    ...
    def test_list_projects_rich_format(self):
        """Should format projects for rich output."""
        stdout, stderr, code = run_cli_raw("jira", "projects", "--format", "rich")
        assert code == 0
...
class TestGetProject:
    ...
    def test_get_project_rich_format(self):
        """Should format project for rich output."""
        stdout, stderr, code = run_cli_raw("jira", "project", TEST_PROJECT, "--format", "rich")
        assert code == 0
...
class TestProjectComponents:
    ...
    def test_project_components_rich_format(self):
        """Should format components for rich output."""
...
class TestProjectVersions:
    ...
    def test_project_versions_rich_format(self):
        """Should format versions for rich output."""
