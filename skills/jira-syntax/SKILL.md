---
name: jira-syntax
description: Use when writing Jira descriptions or comments, converting Markdown to Jira wiki markup, or needing bug report/feature request templates. Triggers - "jira format", "wiki markup", "format for jira", h2./h3. headings, {code:lang} blocks.
---

# Jira Syntax Validation Skill

Provides Jira wiki markup syntax validation, templates, and formatting guidance. For API operations, use the **jira** skill.
...
4. Submit via `jira create --project PROJ --type Bug --summary "..." --description "..."`
